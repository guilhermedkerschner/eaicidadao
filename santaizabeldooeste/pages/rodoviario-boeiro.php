...
<head>
    ...
    <title>Solicitação de Serviços de Boeiros - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="section-title"><i class="fas fa-water"></i> Solicitação de Serviços de Boeiros</h2>

        <div class="service-description">
            <h3><i class="fas fa-info-circle"></i> O que são serviços de Boeiros?</h3>
            <p>Os boeiros são estruturas essenciais para a drenagem das estradas, permitindo que a água escoe adequadamente e prevenindo danos à infraestrutura viária. A manutenção correta destas estruturas é fundamental para garantir a trafegabilidade das estradas rurais, principalmente em períodos chuvosos.</p>
            
            <p>A Secretaria de Obras realiza os seguintes serviços relacionados a boeiros:</p>
            <ul>
                <li><strong>Instalação de novos boeiros:</strong> Construção de estruturas de drenagem em locais necessários</li>
                <li><strong>Substituição de boeiros danificados:</strong> Troca de tubulações quebradas ou comprometidas</li>
                <li><strong>Limpeza de boeiros entupidos:</strong> Remoção de sedimentos, vegetação e outros materiais que obstruem a passagem da água</li>
                <li><strong>Ampliação da capacidade de drenagem:</strong> Aumento do diâmetro das tubulações ou construção de estruturas complementares</li>
            </ul>
        </div>
            ...
            <form id="boeirosForm">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo-servico" name="tipo-servico" class="form-control" required>
                        ...
                        <option value="instalacao">Instalação de novo boeiro</option>
                        <option value="substituicao">Substituição de boeiro danificado</option>
                        <option value="limpeza">Limpeza de boeiro entupido</option>
                        <option value="ampliacao">Ampliação da capacidade de drenagem</option>
                    </select>
                </div>
    ...
    <script>
        ...
        document.getElementById('boeirosForm').addEventListener('submit', function(e) {
            e.preventDefault();
            
            // Simulação de envio
            alert('Solicitação enviada com sucesso! Seu protocolo é: BOE-' + Math.floor(Math.random() * 9000 + 1000) + '.');
            
            // Redirecionamento após o envio
            window.location.href = 'relatorio_boeiros.php';
        });
