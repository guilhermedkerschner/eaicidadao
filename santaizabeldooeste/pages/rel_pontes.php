...
<head>
    ...
    <title>Relatório de Solicitação - Serviços de Pontes - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <a href="formulario_pontes.php">Solicitação de Serviços de Pontes</a>
            <span class="separator">›</span>
        ...
        <div class="report-header">
            <div>
                ...
                <p class="report-subtitle">Serviços de Pontes - Setor Rodoviário</p>
        ...
        <div class="report-section">
            ...
            <div class="info-row">
                <div class="info-group">
                    ...
                    <div class="info-value" id="localizacao">-</div>
                </div>
                <div class="info-group">
            ...
            <div class="info-row">
                <div class="info-group">
                    <div class="info-label">Dimensões da Ponte</div>
                    <div class="info-value" id="dimensoes">-</div>
                </div>
                <div class="info-group">
                    <div class="info-label">Fluxo de Veículos</div>
                    <div class="info-value" id="fluxoVeiculos">-</div>
                </div>
            </div>
            <div class="info-row">
                <div class="info-group">
                    <div class="info-label">Tipos de Veículos</div>
                    <div class="info-value" id="tipoVeiculo">-</div>
                </div>
                <div class="info-group">
        ...
        <div class="status-box">
            ...
            <ul class="status-info">
                ...
                <li>O prazo estimado para análise inicial é de até 5 dias úteis.</li>
        ...
        <div id="email-status" style="display: none;" class="status-box">
        ...
        <div class="action-buttons">
            ...
            <a href="../rodoviario.php" class="btn btn-secondary">
                <i class="fas fa-road"></i> Voltar ao Setor Rodoviário
            </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const solicitacaoData = JSON.parse(localStorage.getItem('solicitacaoPontes'));
            
            if (solicitacaoData) {
                // Preencher os campos do relatório com os dados do localStorage
                document.getElementById('protocolNumber').textContent = solicitacaoData.protocolo || 'PNT-' + Math.floor(Math.random() * 9000 + 1000);
                
                // Criar data e hora atuais se não existirem
                const agora = new Date();
                const dataFormatada = solicitacaoData.data || agora.toLocaleDateString('pt-BR');
                const horaFormatada = solicitacaoData.hora || agora.toLocaleTimeString('pt-BR', {hour: '2-digit', minute:'2-digit'});
                
                document.getElementById('reportDateTime').textContent = 'Gerado em: ' + dataFormatada + ' às ' + horaFormatada;
                ...
                document.getElementById('email').textContent = solicitacaoData.email || 'Não informado';
                
                document.getElementById('tipoServico').textContent = solicitacaoData.tipoServico || '-';
                document.getElementById('dataSolicitacao').textContent = dataFormatada + ' às ' + horaFormatada;
                document.getElementById('localizacao').textContent = solicitacaoData.localizacao || '-';
                document.getElementById('referencia').textContent = solicitacaoData.referencia || 'Não informado';
                document.getElementById('gps').textContent = solicitacaoData.gps || 'Não informado';
                document.getElementById('urgencia').textContent = solicitacaoData.urgencia || '-';
                
                // Formatação para as dimensões da ponte
                const comprimento = solicitacaoData.comprimento || '-';
                const largura = solicitacaoData.largura || '-';
                if (comprimento !== '-' && largura !== '-') {
                    document.getElementById('dimensoes').textContent = `${comprimento}m × ${largura}m`;
                } else {
                    document.getElementById('dimensoes').textContent = 'Não informado';
                }
                
                document.getElementById('fluxoVeiculos').textContent = solicitacaoData.fluxoVeiculos || '-';
                document.getElementById('tipoVeiculo').textContent = solicitacaoData.tipoVeiculo || '-';
                document.getElementById('fotos').textContent = solicitacaoData.fotos || 'Nenhuma foto anexada';
                
                document.getElementById('descricao').textContent = solicitacaoData.descricao || '-';
                document.getElementById('observacoes').textContent = solicitacaoData.observacoes || 'Nenhuma observação adicional.';
                ...
                // Simular dados quando não houver localStorage (para propósitos de demonstração)
                document.getElementById('protocolNumber').textContent = 'PNT-' + Math.floor(Math.random() * 9000 + 1000);
                ...
                // Alertar o usuário mas não redirecionar (para fins de demonstração)
                console.warn('Utilizando dados simulados para demonstração.');
            }
        });
    </script>
</body>
