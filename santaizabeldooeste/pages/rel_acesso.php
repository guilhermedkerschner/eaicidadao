...
<head>
    ...
    <title>Relatório de Solicitação - Acesso - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <a href="formulario-acesso.html">Solicitação de Serviços de Acesso</a>
            <span class="separator">›</span>
        ...
        <div class="report-header">
            <div>
                ...
                <p class="report-subtitle">Serviços de Acesso - Setor Rodoviário</p>
        ...
        <div class="report-section">
            ...
            <div class="info-row">
                <div class="info-group">
                    <div class="info-label">Endereço da Propriedade</div>
                    <div class="info-value" id="endereco">-</div>
                </div>
                <div class="info-group">
                    <div class="info-label">Largura Necessária</div>
                    <div class="info-value" id="largura">-</div>
                </div>
            </div>
            <div class="info-row">
                <div class="info-group">
            ...
            <div class="info-row">
                <div class="info-group">
                    ...
                    <div class="info-value" id="motivo">-</div>
                </div>
                <div class="info-group">
        ...
        <div class="action-buttons">
            ...
            <a href="setor-rodoviario.html" class="btn btn-primary">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const solicitacaoData = JSON.parse(localStorage.getItem('solicitacaoAcesso'));
            ...
            if (solicitacaoData) {
                ...
                document.getElementById('endereco').textContent = solicitacaoData.endereco;
                document.getElementById('largura').textContent = solicitacaoData.largura;
                ...
                document.getElementById('motivo').textContent = solicitacaoData.motivo;
