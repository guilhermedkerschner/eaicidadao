    ...
    try {
        switch ($acao) {
            case 'atualizar_status':
                ...
                $stmt = $conn->prepare("UPDATE tb_cad_social SET cad_social_status = :status, cad_social_data_atualizacao = NOW() WHERE cad_social_id = :id");
...
try {
    $stats_sql = "SELECT 
        COUNT(*) as total,
        SUM(CASE WHEN cad_social_status = 'PENDENTE DE ANÁLISE' THEN 1 ELSE 0 END) as pendentes,
        SUM(CASE WHEN cad_social_status = 'EM ANÁLISE' THEN 1 ELSE 0 END) as em_analise,
        SUM(CASE WHEN cad_social_status = 'APROVADO' THEN 1 ELSE 0 END) as aprovados,
        SUM(CASE WHEN cad_social_status = 'REPROVADO' THEN 1 ELSE 0 END) as reprovados
    ...
    $estatisticas = ['total' => 0, 'pendentes' => 0, 'em_analise' => 0, 'aprovados' => 0, 'reprovados' => 0];
}
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                <div class="stat-number"><?php echo number_format($estatisticas['em_analise']); ?></div>
                <div class="stat-label">Em Análise</div>
                <i class="fas fa-search stat-icon"></i>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?php echo number_format($estatisticas['aprovados']); ?></div>
                <div class="stat-label">Aprovados</div>
                <i class="fas fa-check-circle stat-icon"></i>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?php echo number_format($estatisticas['reprovados']); ?></div>
