...
<head>
    ...
    <title>Setor de Meio Ambiente - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <h2 class="section-title"><i class="fas fa-leaf"></i> Setor de Meio Ambiente</h2>

        <p class="intro-text">
            O Setor de Meio Ambiente do Município de Santa Izabel do Oeste é responsável pela implementação de políticas públicas que visam a preservação ambiental, a gestão adequada de resíduos e a educação ambiental. Nosso objetivo é garantir um município mais sustentável para as gerações presentes e futuras. Selecione abaixo o serviço que você deseja solicitar ou consultar.
        </p>

        <div class="service-buttons">
            <a href="form_lixo_organico.php" class="service-button">
                <i class="fas fa-apple-alt"></i>
                <h3>Lixo Orgânico</h3>
                <p>Informações sobre coleta e descarte adequado de resíduos orgânicos</p>
            </a>

            <a href="form_lixo_reciclavel.php" class="service-button">
                <i class="fas fa-recycle"></i>
                <h3>Lixo Reciclável</h3>
                <p>Orientações sobre separação e coleta de materiais recicláveis</p>
            </a>

            <a href="cronograma_vidro.php" class="service-button">
                <i class="fas fa-wine-bottle"></i>
                <h3>Cronograma de Coleta de Vidro</h3>
                <p>Datas e locais para coleta especializada de vidro</p>
            </a>

            <a href="form_uso_ocupacao_solo.php" class="service-button">
                <i class="fas fa-map-marked-alt"></i>
                <h3>Uso e Ocupação do Solo</h3>
                <p>Emissão de documentos e orientações sobre uso e ocupação do solo</p>
            </a>

            <a href="form_animais.php" class="service-button">
                <i class="fas fa-paw"></i>
                <h3>Animais</h3>
                <p>Orientações sobre bem-estar animal, denúncias e adoção responsável</p>
            </a>

            <a href="form_protecao_fontes.php" class="service-button">
                <i class="fas fa-tint"></i>
                <h3>Proteção de Fontes</h3>
                <p>Informações sobre preservação e proteção de nascentes e fontes de água</p>
            </a>

            <a href="form_educacao_ambiental.php" class="service-button">
                <i class="fas fa-book"></i>
                <h3>Educação Ambiental</h3>
                <p>Projetos e materiais educativos sobre práticas sustentáveis</p>
            </a>
            
            <a href="coopsio.php" class="service-button">
                <i class="fas fa-people-carry"></i>
                <h3>COOPSIO</h3>
                <p>Cooperativa de Trabalho dos Coletores de Material Reciclável do Município de Santa Izabel do Oeste</p>
            </a>
        </div>
        ...
        <div class="contact-section">
            <h3 class="contact-title"><i class="fas fa-address-card"></i> Contato do Setor de Meio Ambiente</h3>
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Endereço</h4>
                            <p>Rua Acácia, 1317 - Centro<br>Santa Izabel do Oeste - PR<br>CEP: 85650-000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Telefones</h4>
                            <p>(46) 3542-0000 (Secretaria)<br>(46) 3542-0000 (Denúncias)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>E-mail</h4>
                            <p>meioambiente@santaizabel.pr.gov.br<br>denuncias.ambientais@santaizabel.pr.gov.br</p>
                        </div>
                    </div>
                </div>
            </div>
