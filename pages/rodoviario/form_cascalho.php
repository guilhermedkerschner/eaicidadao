...
<head>
    ...
    <title>Solicitação de Cascalhamento - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <span class="current">Solicitação de Cascalhamento</span>
        </div>

        <h2 class="section-title"><i class="fas fa-truck-pickup"></i> Solicitação de Cascalhamento</h2>

        <div class="service-description">
            <h3><i class="fas fa-info-circle"></i> O que são serviços de Cascalhamento?</h3>
            <p>O cascalhamento é fundamental para melhorar a trafegabilidade das estradas rurais, especialmente em períodos chuvosos. Este serviço consiste na aplicação de uma camada de cascalho sobre a superfície da estrada, o que reduz a formação de atoleiros, melhora a aderência dos veículos e prolonga a vida útil das vias.</p>
            
            <p>A Secretaria de Obras realiza os seguintes serviços relacionados ao cascalhamento:</p>
            <ul>
                <li><strong>Cascalhamento de estradas rurais:</strong> Aplicação de camada de cascalho em estradas não pavimentadas</li>
                <li><strong>Recascalhamento de trechos críticos:</strong> Reforço da camada de cascalho em pontos com maior desgaste</li>
                <li><strong>Aplicação de cascalho em acessos:</strong> Melhoria da entrada de propriedades rurais</li>
                <li><strong>Correção de pontos críticos:</strong> Tratamento localizado de áreas com problemas específicos</li>
            </ul>
        </div>
            ...
            <form id="cascalhamentoForm">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo-servico" name="tipo-servico" class="form-control" required>
                        ...
                        <option value="cascalhamento">Cascalhamento de estrada rural</option>
                        <option value="recascalhamento">Recascalhamento de trecho crítico</option>
                        <option value="acesso">Aplicação de cascalho em acesso a propriedade</option>
                        <option value="pontos">Correção de pontos críticos</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="localizacao" class="required-field">Localização</label>
                    <input type="text" id="localizacao" name="localizacao" class="form-control" placeholder="Ex: Estrada da Linha São Pedro, próximo à propriedade do Sr. José" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="referencia" name="referencia" class="form-control" placeholder="Ex: Entre a ponte e o entroncamento da Linha Catarina / Próximo ao Armazém Souza">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="motivo" name="motivo" class="form-control" required>
                        ...
                        <option value="atoleiro">Formação de atoleiros</option>
                        <option value="erosao">Erosão da via</option>
                        <option value="buracos">Buracos na pista</option>
                        <option value="preventivo">Manutenção preventiva</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="descricao" class="required-field">Descrição do Problema</label>
                    <textarea id="descricao" name="descricao" class="form-control" rows="5" placeholder="Descreva detalhadamente o problema, informando há quanto tempo existe, as dificuldades que está causando e outras informações relevantes..." required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="urgencia" name="urgencia" class="form-control" required>
                        ...
                        <option value="media">Média - Dificuldades para transitar, mas ainda é possível</option>
                        <option value="alta">Alta - Trânsito muito difícil, risco de atolamento</option>
                        <option value="critica">Crítica - Intransitável, atoleiros frequentes</option>
                    </select>
                </div>
    ...
    <script>
        ...
        document.getElementById('cascalhamentoForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            setTimeout(() => {
                try {
                    ...
                    const protocolo = 'CAS-' + new Date().getFullYear() + '-' + Math.floor(Math.random() * 9000 + 1000);
                    
                    // Armazenar dados da solicitação para exibição na página de relatório
                    localStorage.setItem('solicitacaoCascalhamento', JSON.stringify({
                        protocolo: protocolo,
                    ...
                    window.location.href = 'rel_cascalho.php';
                } catch (error) {
