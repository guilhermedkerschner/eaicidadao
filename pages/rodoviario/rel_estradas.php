...
<head>
    ...
    <title>Relatório de Solicitação - Estradas - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <a href="formulario_estradas.php">Solicitação de Serviços de Estradas</a>
            <span class="separator">›</span>
        ...
        <div class="report-header">
            <div>
                ...
                <p class="report-subtitle">Serviços de Estradas - Setor Rodoviário</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const solicitacaoData = JSON.parse(localStorage.getItem('solicitacaoEstradas'));
