...
<head>
    ...
    <title>Relatório de Solicitação - Cascalhamento - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <a href="../form_cascalho.php">Solicitação de Cascalhamento</a>
            <span class="separator">›</span>
        ...
        <div class="report-header">
            <div>
                ...
                <p class="report-subtitle">Serviços de Cascalhamento - Setor Rodoviário</p>
        ...
        <div id="email-status" style="display: none;" class="status-box" style="background-color: #fff3e0; margin-top: 20px;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const solicitacaoData = JSON.parse(localStorage.getItem('solicitacaoCascalhamento'));
