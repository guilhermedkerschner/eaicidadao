...
<head>
    ...
    <title>Solicitação de Serviços de Acesso - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <span class="current">Solicitação de Serviços de Acesso</span>
        </div>

        <h2 class="section-title"><i class="fas fa-sign-in-alt"></i> Solicitação de Serviços de Acesso</h2>

        <div class="service-description">
            <h3><i class="fas fa-info-circle"></i> O que são serviços de Acesso?</h3>
            <p>Os serviços de melhoria de acesso são essenciais para garantir que todas as propriedades rurais tenham condições adequadas para entrada e saída de veículos, facilitando o escoamento da produção agrícola e o deslocamento dos moradores.</p>
            
            <p>A Secretaria de Obras realiza os seguintes serviços relacionados a acessos:</p>
            <ul>
                <li><strong>Construção de entradas para propriedades rurais:</strong> Criação de acessos adequados às propriedades que ainda não os possuem</li>
                <li><strong>Instalação de tubulação para acesso:</strong> Colocação de tubos para permitir o escoamento de água em travessias e entradas</li>
                <li><strong>Ampliação de acessos existentes:</strong> Aumento da largura de entradas já existentes para melhorar a passagem de veículos</li>
                <li><strong>Correção de inclinação em entradas:</strong> Ajuste do declive de acessos para facilitar a entrada e saída de veículos</li>
            </ul>
        </div>
            ...
            <form id="acessoForm">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo-servico" name="tipo-servico" class="form-control" required>
                        ...
                        <option value="construcao">Construção de nova entrada</option>
                        <option value="tubulacao">Instalação de tubulação para acesso</option>
                        <option value="ampliacao">Ampliação de acesso existente</option>
                        <option value="inclinacao">Correção de inclinação</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="endereco" class="required-field">Endereço da Propriedade</label>
                    <input type="text" id="endereco" name="endereco" class="form-control" placeholder="Ex: Linha São Francisco, s/n" required>
                    <small class="form-text">Informe o endereço completo da propriedade que necessita do serviço.</small>
                </div>
                
                <div class="form-group">
                    <label for="referencia">Ponto de Referência</label>
                    <input type="text" id="referencia" name="referencia" class="form-control" placeholder="Ex: Próximo ao Armazém Santos / Após a ponte do Rio São José">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            <button type="button" id="btn-obter-localizacao" class="btn btn-primary" style="white-space: nowrap;">
                ...
                <div class="form-group">
                    <label for="largura" class="required-field">Largura Necessária (metros)</label>
                    <input type="number" id="largura" name="largura" class="form-control" min="1" step="0.1" required>
                    <small class="form-text">Informe a largura aproximada desejada para o acesso em metros.</small>
                </div>
                
                <div class="form-group">
                    <label for="descricao" class="required-field">Descrição da Necessidade</label>
                    <textarea id="descricao" name="descricao" class="form-control" rows="5" placeholder="Descreva detalhadamente o que precisa, incluindo problemas atuais e como o acesso será utilizado..." required></textarea>
                </div>
                
                <div class="form-group">
                    <label for="motivo" class="required-field">Motivo da Solicitação</label>
                    <select id="motivo" name="motivo" class="form-control" required>
                        <option value="">-- Selecione o motivo --</option>
                        <option value="escoamento">Escoamento de produção agrícola</option>
                        <option value="mobilidade">Melhorar mobilidade de moradores</option>
                        <option value="seguranca">Questões de segurança</option>
                        <option value="acesso_servicos">Acesso a serviços públicos</option>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text">Você pode selecionar até 3 imagens (máximo 5MB cada) que mostrem o local.</small>
                </div>
                ...
                <div class="form-buttons">
                    <a href="setor-rodoviario.html" class="btn btn-secondary">Cancelar</a>
        ...
        document.getElementById('acessoForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                try {
                    ...
                    const protocolo = 'ACE-' + new Date().getFullYear() + '-' + Math.floor(Math.random() * 9000 + 1000);
                    
                    // Armazenar dados da solicitação para exibição na página de relatório
                    localStorage.setItem('solicitacaoAcesso', JSON.stringify({
                        protocolo: protocolo,
                        ...
                        largura: document.getElementById('largura').value + ' metros',
                    ...
                    window.location.href = 'relatorio_acesso.php';
                } catch (error) {
            ...
            }, 1500); // Simular tempo de processamento de 1,5 segundos
        });
    </script>
</body>
