...
<head>
    ...
    <title>Solicitação de Limpeza de Estradas - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <a href="setor-rodoviario.html">Setor Rodoviário</a>
            <span class="separator">›</span>
            <span class="current">Solicitação de Limpeza de Estradas</span>
        </div>

        <h2 class="section-title"><i class="fas fa-broom"></i> Solicitação de Limpeza de Estradas</h2>

        <div class="service-description">
            <h3><i class="fas fa-info-circle"></i> O que são serviços de Limpeza de Estradas?</h3>
            <p>A limpeza e roçada das margens das estradas rurais é essencial para manter a visibilidade, prevenir incêndios e garantir a drenagem adequada. Uma estrada bem mantida contribui para a segurança dos usuários e para a conservação da própria via.</p>
            
            <p>A Secretaria de Obras realiza os seguintes serviços relacionados à limpeza de estradas:</p>
            <ul>
                <li><strong>Roçada mecanizada das margens:</strong> Corte da vegetação nas laterais das estradas para melhorar a visibilidade</li>
                <li><strong>Remoção de vegetação invasora:</strong> Retirada de plantas que avançam sobre a pista ou prejudicam a drenagem</li>
                <li><strong>Limpeza de valetas e sarjetas:</strong> Desobstrução dos canais de drenagem para evitar acúmulo de água</li>
                <li><strong>Poda de galhos:</strong> Corte de galhos de árvores que avançam sobre a pista, representando risco aos usuários</li>
            </ul>
        </div>
            ...
            <form id="limpezaForm">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo-servico" name="tipo-servico" class="form-control" required>
                        ...
                        <option value="rocada">Roçada mecanizada</option>
                        <option value="vegetacao">Remoção de vegetação invasora</option>
                        <option value="valetas">Limpeza de valetas e sarjetas</option>
                        <option value="poda">Poda de galhos</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="trecho" class="required-field">Trecho da Estrada</label>
                    <input type="text" id="trecho" name="trecho" class="form-control" placeholder="Ex: Estrada da Linha Catarinense, Km 3 ao 5" required>
                ...
                <div class="form-group">
                    ...
                    <select id="urgencia" name="urgencia" class="form-control" required>
                        ...
                        <option value="media">Média - Problemas visíveis, mas sem grandes riscos</option>
                        <option value="alta">Alta - Visibilidade prejudicada, risco a usuários</option>
                        <option value="critica">Crítica - Risco iminente de acidentes</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="descricao" class="required-field">Descrição da Necessidade</label>
                    <textarea id="descricao" name="descricao" class="form-control" rows="5" placeholder="Descreva detalhadamente o problema, informando o tipo de vegetação, o quanto ela avança sobre a pista, problemas de drenagem, etc." required></textarea>
                </div>
    ...
    <script>
        ...
        document.getElementById('limpezaForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            setTimeout(() => {
                try {
                    ...
                    const protocolo = 'LIM-' + new Date().getFullYear() + '-' + Math.floor(Math.random() * 9000 + 1000);
                    
                    // Armazenar dados da solicitação para exibição na página de relatório
                    localStorage.setItem('solicitacaoLimpeza', JSON.stringify({
                        protocolo: protocolo,
                    ...
                    window.location.href = 'rel_limpeza.php';
                } catch (error) {
