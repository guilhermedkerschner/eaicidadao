...
<head>
    ...
    <title>Setor de Fazenda - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <h2 class="section-title"><i class="fas fa-chart-line"></i> Setor de Fazenda</h2>

        <p class="intro-text">
            O Setor de Fazenda do Município de Santa Izabel do Oeste é responsável pela administração financeira, contábil e tributária do município. Trabalhamos para garantir a arrecadação justa de tributos, a transparência na aplicação dos recursos públicos e o equilíbrio das contas municipais. Nossa missão é promover uma gestão financeira eficiente e responsável, contribuindo para o desenvolvimento sustentável do município. Selecione abaixo o serviço que você deseja acessar.
        </p>

        <div class="service-buttons">
            <a href="iptu.php" class="service-button">
                <i class="fas fa-home"></i>
                <h3>IPTU</h3>
                <p>Emissão de guias, consultas e parcelamentos</p>
            </a>

            <a href="iss.php" class="service-button">
                <i class="fas fa-briefcase"></i>
                <h3>ISS</h3>
                <p>Informações sobre o Imposto Sobre Serviços</p>
            </a>

            <a href="nfe.php" class="service-button">
                <i class="fas fa-file-invoice-dollar"></i>
                <h3>Nota Fiscal Eletrônica</h3>
                <p>Acesso ao sistema de emissão de NFe</p>
            </a>

            <a href="certidoes.php" class="service-button">
                <i class="fas fa-certificate"></i>
                <h3>Certidões</h3>
                <p>Emissão de certidões negativas e positivas</p>
            </a>

            <a href="alvara.php" class="service-button">
                <i class="fas fa-file-signature"></i>
                <h3>Alvará</h3>
                <p>Emissão e renovação de alvará de funcionamento</p>
            </a>

            <a href="itbi.php" class="service-button">
                <i class="fas fa-exchange-alt"></i>
                <h3>ITBI</h3>
                <p>Imposto sobre Transmissão de Bens Imóveis</p>
            </a>

            <a href="divida_ativa.php" class="service-button">
                <i class="fas fa-exclamation-circle"></i>
                <h3>Dívida Ativa</h3>
                <p>Consulta e negociação de débitos municipais</p>
            </a>

            <a href="portal_transparencia.php" class="service-button">
                <i class="fas fa-search-dollar"></i>
                <h3>Portal da Transparência</h3>
                <p>Acesso às informações sobre gastos públicos</p>
            </a>

            <a href="cadastro_contribuinte.php" class="service-button">
                <i class="fas fa-user-edit"></i>
                <h3>Cadastro de Contribuinte</h3>
                <p>Atualização de dados cadastrais</p>
            </a>
        </div>
        ...
        <div class="contact-section">
            <h3 class="contact-title"><i class="fas fa-address-card"></i> Contato do Setor de Fazenda</h3>
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Endereço</h4>
                            <p>Rua das Oliveiras, 520 - Centro<br>Santa Izabel do Oeste - PR<br>CEP: 85650-000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Telefones</h4>
                            <p>(46) 3552-1410 (Tributos)<br>(46) 3552-1411 (Contabilidade)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>E-mail</h4>
                            <p>fazenda@santaizabel.pr.gov.br<br>tributos@santaizabel.pr.gov.br</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="opening-hours">
                ...
                <table class="hours-table">
                    ...
                    <tr>
                        ...
                        <td>Todos os dias: Conforme legislação vigente</td>
                    </tr>
                </table>
            </div>
        </div>
