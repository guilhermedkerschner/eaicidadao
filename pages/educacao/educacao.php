...
<head>
    ...
    <title>Setor de Educação - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <h2 class="section-title"><i class="fas fa-graduation-cap"></i> Setor de Educação</h2>

        <p class="intro-text">
            O Setor de Educação do Município de Santa Izabel do Oeste é responsável por coordenar e gerir as atividades educacionais da rede municipal de ensino, garantindo um ensino de qualidade para crianças, jovens e adultos. Nossa missão é promover uma educação inclusiva, inovadora e transformadora, contribuindo para o desenvolvimento integral dos alunos e para o progresso do município. Selecione abaixo o serviço que você deseja acessar.
        </p>

        <div class="service-buttons">
            <a href="form_matriculas.php" class="service-button">
                <i class="fas fa-user-graduate"></i>
                <h3>Matrículas</h3>
                <p>Informações sobre matrículas na rede municipal de ensino</p>
            </a>

            <a href="form_transferencia.php" class="service-button">
                <i class="fas fa-exchange-alt"></i>
                <h3>Transferência Escolar</h3>
                <p>Solicitação de transferência entre escolas municipais</p>
            </a>

            <a href="form_transporte.php" class="service-button">
                <i class="fas fa-bus"></i>
                <h3>Transporte Escolar</h3>
                <p>Cadastro e informações sobre transporte escolar</p>
            </a>

            <a href="form_merenda.php" class="service-button">
                <i class="fas fa-utensils"></i>
                <h3>Merenda Escolar</h3>
                <p>Informações sobre alimentação escolar e cardápio</p>
            </a>

            <a href="form_eja.php" class="service-button">
                <i class="fas fa-book-reader"></i>
                <h3>EJA</h3>
                <p>Educação de Jovens e Adultos</p>
            </a>

            <a href="lista_escolas.php" class="service-button">
                <i class="fas fa-school"></i>
                <h3>Escolas Municipais</h3>
                <p>Lista de todas as escolas e CMEIs do município</p>
            </a>

            <a href="calendario_escolar.php" class="service-button">
                <i class="fas fa-calendar-alt"></i>
                <h3>Calendário Escolar</h3>
                <p>Datas importantes do ano letivo</p>
            </a>

            <a href="form_documentos.php" class="service-button">
                <i class="fas fa-file-alt"></i>
                <h3>Documentos Escolares</h3>
                <p>Solicitação de históricos, declarações e outros documentos</p>
            </a>

            <a href="form_concursos.php" class="service-button">
                <i class="fas fa-clipboard-check"></i>
                <h3>Concursos e PSS</h3>
                <p>Informações sobre processos seletivos na área da educação</p>
            </a>
        </div>
        ...
        <div class="contact-section">
            <h3 class="contact-title"><i class="fas fa-address-card"></i> Contato do Setor de Educação</h3>
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Endereço</h4>
                            <p>Rua Cerejeira, 850 - Centro<br>Santa Izabel do Oeste - PR<br>CEP: 85650-000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Telefones</h4>
                            <p>(46) 3552-1490 (Secretaria)<br>(46) 3552-1491 (Transporte Escolar)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>E-mail</h4>
                            <p>educacao@santaizabel.pr.gov.br<br>transporte.escolar@santaizabel.pr.gov.br</p>
                        </div>
                    </div>
                </div>
            </div>
