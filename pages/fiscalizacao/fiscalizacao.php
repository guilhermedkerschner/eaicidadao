...
<head>
    ...
    <title>Setor de Fiscalizações - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <h2 class="section-title"><i class="fas fa-clipboard-check"></i> Setor de Fiscalizações</h2>

        <p class="intro-text">
            O Setor de Fiscalizações do Município de Santa Izabel do Oeste é responsável por garantir o cumprimento das leis municipais, verificando e fiscalizando atividades comerciais, obras, posturas municipais, vigilância sanitária, entre outros aspectos. Nosso objetivo é promover o bom ordenamento urbano e a qualidade de vida no município. Selecione abaixo o serviço que você deseja acessar.
        </p>

        <div class="service-buttons">
            <a href="form_alvara.php" class="service-button">
                <i class="fas fa-file-signature"></i>
                <h3>Alvará de Funcionamento</h3>
                <p>Solicitação e renovação de alvará para estabelecimentos</p>
            </a>

            <a href="form_obras.php" class="service-button">
                <i class="fas fa-hard-hat"></i>
                <h3>Fiscalização de Obras</h3>
                <p>Solicitações e denúncias relacionadas a obras e construções</p>
            </a>

            <a href="form_sanitaria.php" class="service-button">
                <i class="fas fa-notes-medical"></i>
                <h3>Vigilância Sanitária</h3>
                <p>Fiscalização sanitária e solicitação de vistorias</p>
            </a>

            <a href="form_posturas.php" class="service-button">
                <i class="fas fa-balance-scale"></i>
                <h3>Posturas Municipais</h3>
                <p>Normas e regulamentos sobre uso do espaço público</p>
            </a>

            <a href="form_comercio.php" class="service-button">
                <i class="fas fa-store"></i>
                <h3>Comércio e Serviços</h3>
                <p>Fiscalização e licenças para comércio e serviços</p>
            </a>

            <a href="form_feiras.php" class="service-button">
                <i class="fas fa-shopping-basket"></i>
                <h3>Feiras e Ambulantes</h3>
                <p>Cadastro e fiscalização de feirantes e ambulantes</p>
            </a>

            <a href="form_denuncia.php" class="service-button">
                <i class="fas fa-exclamation-triangle"></i>
                <h3>Denúncias</h3>
                <p>Registro de denúncias sobre irregularidades no município</p>
            </a>

            <a href="form_tributaria.php" class="service-button">
                <i class="fas fa-file-invoice-dollar"></i>
                <h3>Fiscalização Tributária</h3>
                <p>Informações sobre tributos, notas fiscais e guias</p>
            </a>

            <a href="form_meio_ambiente.php" class="service-button">
                <i class="fas fa-leaf"></i>
                <h3>Fiscalização Ambiental</h3>
                <p>Denúncias e fiscalização de infrações ambientais</p>
            </a>
        </div>
        ...
        <div class="contact-section">
            <h3 class="contact-title"><i class="fas fa-address-card"></i> Contato do Setor de Fiscalizações</h3>
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Endereço</h4>
                            <p>Rua das Araucárias, 245 - Centro<br>Santa Izabel do Oeste - PR<br>CEP: 85650-000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Telefones</h4>
                            <p>(46) 3552-1430 (Fiscalização)<br>(46) 3552-1431 (Vigilância Sanitária)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>E-mail</h4>
                            <p>fiscalizacao@santaizabel.pr.gov.br<br>vigilancia@santaizabel.pr.gov.br</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="opening-hours">
                ...
                <table class="hours-table">
                    ...
                    <tr>
                        <td>Plantão de Denúncias</td>
                        <td>Sábados: 09:00 às 12:00 (somente pelo telefone)</td>
                    </tr>
                </table>
            </div>
        </div>
