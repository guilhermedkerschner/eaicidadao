...
<head>
    ...
    <title>Relatório de Solicitação - Boeiros - Eai Cidadão!</title>
...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="separator">›</span>
            <a href="formulario-boeiros.html">Solicitação de Serviços de Boeiros</a>
            <span class="separator">›</span>
        ...
        <div class="report-header">
            <div>
                ...
                <p class="report-subtitle">Serviços de Boeiros - Setor Rodoviário</p>
        ...
        <div class="action-buttons">
            ...
            <button id="btn-enviar-email" class="btn btn-outline" style="display: none;" onclick="enviarEmail()">
                <i class="fas fa-envelope"></i> Reenviar por Email
            </button>
            <a href="setor-rodoviario.html" class="btn btn-secondary">
                <i class="fas fa-truck-moving"></i> Voltar ao Setor Rodoviário
            </a>
            <a href="status-servicos.html" class="btn btn-primary">
    ...
    <script>
        // Função para simular o envio do relatório por email
        function enviarEmail() {
            const email = document.getElementById('email').textContent;
            if (email && email !== 'Não informado') {
                // Aqui entraria o código para enviar o email de verdade (no backend)
                // Como é apenas uma simulação, mostramos um alerta
                alert(`Relatório reenviado com sucesso para o email: ${email}`);
            } else {
                alert('Não foi possível enviar o email. Email não informado.');
            }
        }
        
        document.addEventListener('DOMContentLoaded', function() {
            // Recuperar os dados do localStorage
            const solicitacaoData = JSON.parse(localStorage.getItem('solicitacaoBoeiros'));
            ...
            if (solicitacaoData) {
                ...
                // Caso não existam dados no localStorage
